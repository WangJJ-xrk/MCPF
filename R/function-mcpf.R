...
#' Generate Fabonacci Sequence to be Used as Dividing Points
#'
#' \code{Fabonacci} generates a Fabonacci sequence to be used as dividing
...
#' @param fab logical,indicating whether the vector of dividing point
...
mcpf <- function(simi.mat, dis.mat = NULL, null.space,
                 x.mat, n.monterCarlo = 1000, fab = FALSE){
